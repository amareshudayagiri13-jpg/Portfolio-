...
// ─── Main Component (Static — no swing physics) ───────────────────────────────
export const HangingIdCard = ({
  ...
  return (
    ...
    >
      ...
      {/* The Pendulum Assembly (Rope + Lock Clip + Card) — now fixed, no rotation */}
      <div 
      ...
      >
        ...
        {/* ID Card */}
        <div className={cn("relative rounded-[1.75rem] overflow-hidden shadow-2xl border border-foreground/15 dark:border-white/15 bg-card mt-[-16px]", cardWidth)}>
