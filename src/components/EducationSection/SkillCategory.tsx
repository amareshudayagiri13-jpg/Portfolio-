...
export default function ProfessionalProfile() {
  const technicalSkills = [
    { name: "Java", level: 75, icon: Coffee, color: "text-orange-400" },
    { name: "Data Structures & Algorithms", level: 70, icon: Brain, color: "text-cyan-400" },
    { name: "HTML / CSS / JavaScript", level: 80, icon: Code2, color: "text-blue-400" },
    { name: "Git / GitHub", level: 75, icon: GitBranch, color: "text-rose-400" },
    { name: "Tailwind CSS", level: 65, icon: Palette, color: "text-sky-400" },
    { name: "React (learning)", level: 80, icon: Atom, color: "text-cyan-300" },
    { name: "MongoDB", level: 80, icon: Database, color: "text-emerald-400" },
    { name: "MySQL", level: 75, icon: Database, color: "text-amber-400" },
    { name: "PostgreSQL", level: 70, icon: Database, color: "text-indigo-400" },
  ];

  const softSkills = [
    { name: "Leadership", icon: Crown, color: "text-amber-400 border-amber-500/30 bg-amber-500/10" },
    { name: "Smart Working", icon: Zap, color: "text-orange-400 border-orange-500/30 bg-orange-500/10" },
    { name: "Fast Learner", icon: Lightbulb, color: "text-yellow-400 border-yellow-500/30 bg-yellow-500/10" },
    ...
    { name: "Time Management", icon: Clock, color: "text-sky-400 border-sky-500/30 bg-sky-500/10" },
  ];
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            {technicalSkills.map((skill, i) => {
              ...
              return (
                <div key={i} className="space-y-2">
                  ...
                  <div className="h-2 w-full bg-muted/60 rounded-full overflow-hidden border border-border/40 p-[1px]">
                    <motion.div
        ...
        <div className="glass-panel p-8 rounded-[2rem] border border-foreground/15 shadow-xl flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between mb-8 pb-4 border-b border-border/60">
              <h4 className="text-xl font-bold text-foreground flex items-center gap-2">
                <Brain className="w-5 h-5 text-primary" /> Strengths
              </h4>
              <span className="text-xs font-bold uppercase tracking-wider text-muted-foreground bg-muted/60 px-3 py-1 rounded-full border border-border/50">
                Traits
              </span>
            ...
            <div className="p-4 rounded-2xl bg-gradient-to-r from-primary/10 via-purple-500/5 to-transparent border border-primary/20 flex items-start gap-3.5 shadow-sm">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground leading-relaxed">
                  Currently deepening DSA in Java and exploring the wider web development stack.
                </p>
              </div>
            </div>
          </div>
