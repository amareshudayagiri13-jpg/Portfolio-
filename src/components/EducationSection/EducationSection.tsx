  ...
  const education = [
    {
      ...
      school: "Vignan's Institute of Information Technology (VIIT), Visakhapatnam",
      year: "2024 – 2028",
      badge: "CGPA 9.03",
      badgeIcon: Award,
      ...
      icon: GraduationCap,
      details: [
        "Maintaining a CGPA of 9.03 across the first three semesters",
        "Coursework in Theory of Computation, Probability & Statistics, and Data Warehousing/Data Mining",
        "Building full-stack projects and working through DSA in Java alongside coursework",
        "Certifications from Cisco; participated in Smart India Hackathon, Gen-E Summit, and ShoreFest"
      ]
    },
    {
      degree: "Intermediate (MPC)",
      school: "Ramakrishna Sahakara Junior Kalasala",
      year: "2022 – 2024",
      badge: "96.7% ",
      badgeIcon: Sparkles,
      ...
      icon: BookOpen,
      details: [
        "Scored 967 out of 1000 marks in the Intermediate examination",
        "Built the foundation in Mathematics, Physics, and Chemistry that led into Computer Science Engineering"
      ]
    }
  ];
      ...
      <div>
        ...
        >
          ...
          <p className="text-muted-foreground text-lg max-w-2xl">
            Building the foundation in computer science and problem-solving that powers my project work.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {education.map((edu, i) => {
            ...
            const shineDirections = ["left", "right", "bottom", "top"] as const;
            return (
              <motion.div
                key={i}
                initial={{ opacity: 0, y: 30 }}
